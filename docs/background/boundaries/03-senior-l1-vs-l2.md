...
4. **Architectural decision recorded and adopted.** Has driven at least one architectural decision (documented with a durable artifact) that affected work beyond their own area — and the team is following it months later.
