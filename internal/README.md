...
This folder contains **internal-only working material** for the Roomle career ladder. It is intentionally kept outside `docs/` so it does not appear in the published ladder.

Contents:

- `decisions.md` — log of design decisions, with rationale and KV-related corrections.
- `follow-ups.md` — known open items not yet resolved in the public ladder.
